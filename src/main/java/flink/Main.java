...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if(args.length == 1) {
            print = Boolean.parseBoolean(args[0]);
        }
        ...
        if (print) {
            ...
            q1Stream.sinkTo(new DiscardingSink<>()).name("DiscardSinkQ1");
        }
        //Eseguiamo Query 2
        ...
        if (print) {
            ...
            q2Outlier.sinkTo(new DiscardingSink<>()).name("DiscardSinkQ2");
        }
        ...
        if (print) {
            ...
            clustered.sinkTo(new DiscardingSink<>()).name("DiscardSinkQ3");
        }
